...
def generate(*, experimental: bool = True) -> str:
    lines = [
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experimental", action="store_true",
                        help="include experimental features (math substitutions)")
    args = parser.parse_args()

    output = generate(experimental=args.experimental)
    if args.write:
        OUTPUT_PATH.write_text(output + "\n")
        print(f"wrote {OUTPUT_PATH}  (experimental={args.experimental})")
    else:
        print(output)
